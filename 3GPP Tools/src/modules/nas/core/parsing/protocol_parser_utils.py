...
from modules.nas.core.parsing.protocol_parser_constants import TAG_T, TAG_TAB, TAG_BR, TAG_CR, TAG_HYPHEN, TAG_P, \
    TAG_TR, TAG_TC, TAG_TCPR, TAG_GRIDSPAN, W_NS, TAG_VMERGE
